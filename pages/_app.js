                ...
                <main className="shadow">
                    <div className="max-w-screen-lg mx-auto flex flex-row justify-between items-center p-4 sm:p-7 relative z-10 space-x-2 sm:space-x-3">
                        ...
                        <div className="flex items-center text-sm font-semibold">
                            <Link href={"/search"}>
                                <a className="text-gray-700 text-lg font-bold hover:text-purple-700">Search
                                </a>
                            </Link>
                            <span className="text-gray-700 text-lg font-light ml-5 mr-5">|</span>
                            {user ?
                                <>
